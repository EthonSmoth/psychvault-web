    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-2 text-3xl font-semibold text-slate-900">{totalResources}</div>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="text-sm font-medium text-slate-500">Published</div>
          <div className="mt-2 text-3xl font-semibold text-slate-900">{publishedResources}</div>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="text-sm font-medium text-slate-500">Archived</div>
          <div className="mt-2 text-3xl font-semibold text-slate-900">{archivedResources}</div>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="text-sm font-medium text-slate-500">Followers</div>
          <div className="mt-2 text-3xl font-semibold text-slate-900">{totalFollowers}</div>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="text-sm font-medium text-slate-500">Sales</div>
          <div className="mt-2 text-3xl font-semibold text-slate-900">{totalSales}</div>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="text-sm font-medium text-slate-500">Gross revenue</div>
          <div className="mt-2 text-3xl font-semibold text-slate-900">{formatMoney(grossRevenue)}</div>
        </div>
      </section>
